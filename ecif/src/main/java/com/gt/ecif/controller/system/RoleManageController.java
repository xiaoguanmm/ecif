...
import com.gt.ecif.entity.RoleInfo;
...
public class RoleManageController extends SystemManageController {
	...
	/**角色授权*/
	private static final String ROLE_AUTHORITY = "roleAuthority";
	...
	public String roleAuthority(HttpServletRequest request,HttpServletResponse response){
...
//		ModelAndView  mv = new ModelAndView();
		...
		request.setAttribute("roleId", pid);
		request.setAttribute("code", code);
		request.setAttribute("authorities", roleAuthorities);
//		request.setAttribute(ROLE_AUTHORITY);
