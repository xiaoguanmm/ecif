...
import com.gt.ecif.utils.SimpleDateFormatEditor;
...
public class BaseController {
	...
	public void initBinder(WebDataBinder binder) {
	      binder.registerCustomEditor(Date.class, new SimpleDateFormatEditor());
	}
     ...
     * @return
     */
    public UserInfo getCurrUser(HttpServletRequest request) {
