...
//	validator.addField($("#addUserInfoForm input[name=password]"));
	$(".pwd_div").show();
	validator.enableFieldValidators($("#addUserInfoForm"), "password");
	/*去除用户名只读属性*/
...
function initFormData(dom){
	...
	$("#reset-pwd").show();
	validator.diabledFieldValidators($("#addUserInfoForm"), "password");
	$(".pwd_div").hide();
	$("#reset_no").trigger("click");
	layui.use('form',function(){
		var form = layui.form;
